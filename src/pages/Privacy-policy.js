  ...
  return (
    ...
    <div className="container  mx-auto p-8 bg-white shadow-lg rounded-xl mt-10 border border-gray-200">
      ...
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 border-b pb-2">2. Information Collection</h2>
          <p className="text-gray-700 mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 border-b pb-2">3. Use of Information</h2>
          <p className="text-gray-700 mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 border-b pb-2">4. Security</h2>
          <p className="text-gray-700 mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-gray-800 border-b pb-2">5. Changes to Privacy Policy</h2>
          <p className="text-gray-700 mt-2 leading-relaxed">
